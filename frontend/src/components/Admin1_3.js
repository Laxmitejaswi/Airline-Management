...
export default function Admin1_3() {
    ...
    const handleAddFlight = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch(`https://airline-management-2.onrender.com/api/flights/daily?count=${count}`, {
                method: 'POST',
                headers: {
